...
bool type_specific;	//Do you want to limit "matches" to those CNVS that match our type?
							//ie. a dup and del that overlap would not be considered a match if this is true
